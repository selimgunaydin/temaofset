      ...
      <div className="row h-100">
        <div className="col-12 col-lg-6 d-flex flex-column justify-content-center align-items-center align-items-lg-start">
          <img
            ...
            className="mb-4"
          />
          <h2 className="border-bottom pb-3 mb-3">Websitemiz güncelleniyor</h2>
          <p className="text-center text-lg-start">
            Sizlere daha iyi hizmet sunabilmek için websitemizi güncelliyoruz.
          </p>
        </div>
        <div className="col-12 col-lg-6 d-flex flex-column justify-content-start justify-content-lg-center">
